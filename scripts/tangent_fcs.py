'''
This script takes original FC data and produces tangent projected FCs saved as .pickle files for easier experimentation without unnecessary repetition.
'''
...
if __name__ == '__main__':
    ...
    parcellation = input('Choose from "Schaefer", "Glasser", "Twins": ')
    if parcellation.lower() == 'schaefer':
        for parc in np.arange(400, 600, 100):
